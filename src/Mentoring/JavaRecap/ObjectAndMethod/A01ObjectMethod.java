...
public class A01ObjectMethod {

    // Interview Question from Facebook
    // object --> is the parent of all classes which are the blueprint of the object
    // it has some behaviours.
    // methods of Object --> toString();  it shows all the variables in a String mode
    // methods of Object --> equals();
    // methods of Object --> hashCode(); --> location of the element
    ...
    Create 2 objects of the groceryStore class into the GroceryStoreTest(main method inside)
    houstonStore
    seattleStore
