...
public class Task3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(firstNumber + " + " + secondNumber + " = " + (firstNumber+secondNumber)); // 125 + 24 = 149
        System.out.println(firstNumber + " - " + secondNumber + " = " + (firstNumber-secondNumber)); // 125 - 24 = 101
