...
public class Practice2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Which brand are you interested in?  Samsung TV / Other TV");
        String customer = input.nextLine();

        String answer = customer.equalsIgnoreCase("Samsung") ? "Samsung TV prices are starting from $1199"
